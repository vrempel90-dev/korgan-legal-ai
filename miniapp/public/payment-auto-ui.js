(() => {
  ...
  const replacements = new Map([
    ...
    ['Чек прошёл предварительную проверку. Ожидается ручная сверка по истории Kaspi Pay.', 'Оплата проверяется автоматически по фискальному QR через Kaspi ОФД.'],
    ['AI не признаёт банковский факт окончательно — администратор сверяет реальный платёж.', 'KORGAN проверяет сумму, продавца, время и уникальность фискального чека через Kaspi ОФД.'],
    ['Юридический анализ и генерация Word ещё не начались. Оплатите документ, загрузите чек и дождитесь ручной сверки платежа администратором.', 'Юридический анализ и генерация Word начнутся после подтверждения оплаты. Оплатите через Kaspi и загрузите полный фискальный чек с хорошо видимым QR-кодом.'],
