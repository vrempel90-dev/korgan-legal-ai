...
const L = {
  ru: {
    ...
    download: 'Скачать DOCX', downloadExisting: 'Скачать готовый DOCX', liveReview: 'Консультация с юристом',
    ...
    waitingAdmin: 'Чек прошёл предварительную проверку. Ожидается ручная сверка по истории Kaspi Pay.', paymentApproved: 'Оплата подтверждена', paymentApprovedText: 'Платёж подтверждён. Подготовка документа начинается.', checkPayment: 'Проверить подтверждение', startPaidGeneration: 'Подготовить оплаченный документ',
