...
if (!entry.includes("import './ux-v2.css'")) throw new Error('UX v2 stylesheet import is missing');
if (!entry.includes("import './main.jsx'")) throw new Error('React application import is missing');
if (entry.indexOf("./ux-v2.css") > entry.indexOf("./main.jsx")) throw new Error('UX v2 must load before React execution');
