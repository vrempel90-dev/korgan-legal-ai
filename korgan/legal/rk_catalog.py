...
ACT_SPECS: tuple[ActSpec, ...] = (
    ...
    # Current Constitution: adopted 15.03.2026, effective 01.07.2026 under Art. 94.
    ActSpec("CONSTITUTION_RK", "K2600000000", "Конституция Республики Казахстан", "Конституция РК"),
    ...
    ActSpec("CRIMINAL_RK", "K1400000226", "Уголовный кодекс Республики Казахстан", "УК РК"),
    ActSpec("CRIMINAL_PROCEDURE_RK", "K1400000231", "Уголовно-процессуальный кодекс Республики Казахстан", "УПК РК"),
    ...
    # Current general banking law; the 1995 act has only narrow transition remnants.
    ActSpec("BANKS_RK", "Z2600000258", "Закон Республики Казахстан «О банках и банковской деятельности в Республике Казахстан»", "Закон РК о банках"),
    ...
    # Current civil-service law since 01.07.2026.
    ActSpec("PUBLIC_SERVICE_RK", "Z2600000290", "Закон Республики Казахстан «О государственной службе Республики Казахстан»", "Закон РК о государственной службе"),
