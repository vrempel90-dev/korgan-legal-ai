...
def lawyer_consultation_text(
    ...
    if language == KK:
        return (
            ...
            "Жеке заңгердің консультациясы ақылы. Осы іс бойынша ақылы консультация алғыңыз келе ме?\n\n"
    ...
    return (
        ...
        "Хотите получить платную консультацию персонального юриста по этому делу?\n\n"
        f"📱 {WHATSAPP_NUMBER_DISPLAY}"
    )
