"""Required substantive clauses by document type — protection from silent regressions."""
...
_CONTRACT_BASELINE: tuple[RequiredClause, ...] = (
    RequiredClause("преамбула с идентификацией сторон и основанием полномочий", (r"в дальнейшем.{0,400}на основании",)),
...
_PERSONAL_DATA = RequiredClause("обработка персональных данных пользователей", (r"персональн\w* данн",))
_IP_RIGHTS = RequiredClause("права на результат работ (интеллектуальная собственность)", (r"исключительн\w* прав|интеллектуальн\w* собственност|прав\w* на результат",))
_CONFIDENTIALITY = RequiredClause("конфиденциальность", (r"конфиденциальн",))

SPECS: dict[str, GoldenSpec] = {
    "claim": GoldenSpec("claim", "Исковое заявление", (
    ...
    "response": GoldenSpec("response", "Отзыв на исковое заявление", (
        RequiredClause("наименование суда", (r"в суд:",)),
    ...
    "contract_services": GoldenSpec("contract_services", "Договор возмездного оказания услуг", _CONTRACT_BASELINE + (
    ...
    "contract_it_services": GoldenSpec("contract_it_services", "Договор на разработку и сопровождение IT-решения", _CONTRACT_BASELINE + (
    ...
    "contract_supply": GoldenSpec("contract_supply", "Договор поставки", _CONTRACT_BASELINE + (
    ...
    "contract_work": GoldenSpec("contract_work", "Договор подряда", _CONTRACT_BASELINE + (
    ...
    "contract_lease": GoldenSpec("contract_lease", "Договор имущественного найма (аренды)", _CONTRACT_BASELINE + (
    ...
    "contract_loan": GoldenSpec("contract_loan", "Договор займа", _CONTRACT_BASELINE + (
    ...
    "contract_sale": GoldenSpec("contract_sale", "Договор купли-продажи", _CONTRACT_BASELINE + (
    ...
    "contract_employment": GoldenSpec("contract_employment", "Трудовой договор", _CONTRACT_BASELINE + (
