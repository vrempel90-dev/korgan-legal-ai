...
from korgan.civil_claim_hotfix import ProductionOpenAILegalService
...
async def main() -> None:
    ...
    LOGGER.info("Starting KORGAN civil-claim hotfix runtime: strict legal QA, isolated state duty, reduced retries")
    try:
