...
def render_blocks(doc, blocks: list[Block]) -> None:
    ...
    for block in blocks:
        ...
        if isinstance(block, Heading):
            ...
            paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER if block.centered else WD_ALIGN_PARAGRAPH.LEFT
        ...
        if isinstance(block, Prose):
            paragraph = doc.add_paragraph()
            paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER if block.centered else WD_ALIGN_PARAGRAPH.JUSTIFY
