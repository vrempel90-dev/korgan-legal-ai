...
class ProductionOpenAILegalService(_FastBase):
    ...
    async def draft_claim(
        ...
        prompt = (
            ...
            "6.1. Денежную сумму в требовании обозначай плейсхолдером, а не цифрами: {{principal_amount}}, {{penalty_amount}}, {{claim_price}}, {{state_duty}}, {{total_claim}}. Значения подставит детерминированный расчёт.\n"
