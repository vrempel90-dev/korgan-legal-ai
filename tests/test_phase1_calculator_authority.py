...
Истец: ТОО «KAZ INDUSTRY TRADE», БИН 010140001234, г. Алматы, ул. Абая, 150, офис 12
Ответчик: ТОО «АлматыСтройСнаб», БИН 020240005678, г. Алматы, пр. Райымбека, 208
...
Истец: ТОО «ASTANA SUPPLY GROUP», БИН 030340009012, г. Астана, ул. Кунаева, 12
Ответчик: ТОО «Сарыарка Логистик», БИН 040440003456, г. Астана, ул. Сейфуллина, 3
...
def _model_draft(**overrides) -> ClaimDraft:
    ...
    base = dict(
        ...
        claimant=["ТОО «KAZ INDUSTRY TRADE», БИН 010140001234"],
        defendant=["ТОО «АлматыСтройСнаб», БИН 020240005678"],
...
def test_penalty_the_client_never_asked_for_leaves_no_trace() -> None:
    ...
    """
    context = (
        "Истец: ТОО «KAZ INDUSTRY TRADE», БИН 010140001234. "
        "Ответчик: ТОО «АлматыСтройСнаб», БИН 020240005678. "
