...
def _row(*, idx: int, jurisdiction: str = "KZ", lang: str = "ru", url: str | None = None) -> dict[str, object]:
    return {
...
def test_agent_retrieval_fuses_official_and_kz_only_candidates(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(pipeline, "_ensure_background_bootstrap", lambda: None)
