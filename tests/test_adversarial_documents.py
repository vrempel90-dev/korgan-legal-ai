...
# Материалы дела — это то, что доверитель передал: требование оппонента,
# первичные документы и его собственная позиция. Возражение проверяется против
# них, поэтому каждая сумма, дата и пункт договора, на которые опирается ответ,
# существуют здесь, а не появляются в тексте документа впервые.
CASE_CONTEXT = (
    ...
    "Претензия от 05.03.2026 № 7: истец требует 2 300 000 тенге долга и "
    "71 300 тенге неустойки, начисленной с 01.03.2026.\n"
    "В акте от 20.02.2026 зафиксированы недостатки работ на сумму 900 000 тенге; "
    "срок оплаты по пункту 4.2 договора наступает 20.03.2026.\n"
    "Позиция ответчика: признаём бесспорную часть 1 400 000 тенге и готовы её оплатить, "
    "работы на 900 000 тенге не приняты."
)
ARTICLE_623 = (
