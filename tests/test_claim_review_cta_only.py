...
def test_cta_is_exactly_claim_only() -> None:
...
def test_russian_cta_is_limited_to_this_claim_and_discloses_extra_payment() -> None:
    ...
    assert "word-файл" in text.lower()
