...
FIELDS: dict[str, InterviewField] = {
    ...
    for field in (
        ...
        InterviewField(
            ...
            hint_ru="Перечислите через запятую. Например: договор, акт оказанных услуг, "
            "счёт-фактура, претензия, чек об отправке претензии, квитанция об уплате госпошлины, "
            "справка о регистрации, приказ о назначении руководителя (или доверенность на "
            "представителя).",
            hint_kk="Үтір арқылы тізіңіз. Мысалы: шарт, көрсетілген қызмет актісі, шот-фактура, "
            "наразылық, наразылықты жіберу түбіртегі, мемлекеттік баж түбіртегі, тіркеу "
            "анықтамасы, басшыны тағайындау бұйрығы (немесе өкілге сенімхат).",
            required=True,
            unknown_ok=False,
        ),
        InterviewField(
